...
<table width="100%">
  ...
  <tr>
    <td valign="top">
      ...
      С версии 3.3.x проект перешел на раздельную сервисную архитектуру. Пакет работает как умный генератор конфигурации <code>telemt.toml</code> и надежно управляет жизненным циклом демона через подсистему <code>procd</code>, взаимодействуя с ядром через новый <b>Control API v1</b>.<br><br>
