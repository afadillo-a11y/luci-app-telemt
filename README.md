...
<table width="100%">
  ...
  <tr>
    <td valign="top">
      ...
      Реализовано отображение статуса процесса, проверка правила firewall'а для выбранного порта, полу-автоматическое определение WAN IP-адреса с подстановкой в прокси-ссылку, генерация секрета для каждого пользователя, управлених их квотами.  
      <br><br>
      <b>Требования:</b>
      <ul>
