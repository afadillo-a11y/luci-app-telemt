<div align="center">
  ...
  <p><b>luci-app-telemt v3.1.0 - веб-апплет для управления сервисом MTProxy telemt на роутерах под управлением OpenWRT</b> | <i>Как веб-интерфейс, инит-система и бинарник соображают на троих</i></p>
</div>
