<div align="center">
  ...
  <p><b>luci-app-telemt v3.x.x - веб-апплет для управления сервисом MTProxy telemt на OpenWRT роутерах</b> | <i>Как веб-интерфейс, инит-система и бинарник соображают на троих</i></p>
</div>
