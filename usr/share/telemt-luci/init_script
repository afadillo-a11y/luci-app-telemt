...
# Version: 3.1.4-9 (Epoch 1) - STRICT UPSTREAM SAFETY
# ==============================================================================
START=99
STOP=10
USE_PROCD=1
...
start_service() {
    ...
    local metrics_port m_alo m_alan metrics_whitelist domain log_level use_mp use_stun ad_tag announce_ip external_ip
